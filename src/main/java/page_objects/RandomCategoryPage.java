...
public class RandomCategoryPage extends BasePage {
    ...
    public List< String > getValues() {
        ...
        driver.findElements(productsBlock).stream().forEach(product -> allProductData.add(product.getText()));
    ...
    public boolean getValuesPrices() {
        ...
        driver.findElements(productsOldPrices).stream().forEach(product -> oldPrices.add(product.getText().
                replaceAll(" грн.","")));
        ...
        driver.findElements(productsCurrentPrices).stream().forEach(product -> newPrices.add(product.getText().
                replaceAll(" грн.","")));
        Reporter.log("Deleting unused chars from the str ");
   ...
   public boolean compareSizes(){
        ...
        driver.findElements(productsSizes).stream().forEach(product -> sizes.add(product.getText().
                replaceAll("Розміри: ","")));
       Reporter.log("Deleting unused chars from the str ");
